...
import { User, Mail, Briefcase, Camera, Save, ArrowRightLeft, TrendingUp, AlertCircle, Loader2 } from 'lucide-react';
...
const Settings: React.FC<SettingsProps> = ({ currentExchangeRate, onExchangeRateChange }) => {
  ...
  const [selectedRateType, setSelectedRateType] = useState<string>('manual'); // 'manual' | 'oficial' | 'blue' | 'mep' ...
      ...
      <section className="space-y-6">
         ...
         <div className="flex flex-col md:flex-row gap-8 items-start">
            ...
            <div className="relative group">
               <div className="size-32 rounded-full border-4 border-surface shadow-xl bg-cover bg-center" style={{ backgroundImage: `url(${user.avatar})` }}></div>
            ...
            <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
               ...
               <div className="space-y-2">
                  <label className="text-xs font-bold text-slate-500 uppercase tracking-wider">Ocupación</label>
                  <div className="relative">
         ...
         <div className="flex justify-end">
            <button className="flex items-center gap-2 bg-slate-900 dark:bg-white text-white dark:text-slate-900 px-6 py-3 rounded-xl font-bold text-sm hover:scale-105 transition-transform">
